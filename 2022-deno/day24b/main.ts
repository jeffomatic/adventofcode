...
const period = states.length;
const a = vec2.make(-1, 0);
const b = vec2.make(initial.dimensions[0], initial.dimensions[1] - 1);
const leg1 = search(states, 0, a, b);
const leg2 = search(states, leg1 % period, b, a);
const leg3 = search(states, (leg1 + leg2) % period, a, b);
